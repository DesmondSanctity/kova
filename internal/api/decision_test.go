...
func TestDecide(t *testing.T) {
	...
	cases := []struct {
		...
		{"declined low score even band D", 30, "D", 100000, 40000_00, 0, 0, "declined", 0},
		{"band D small request within limit approved", 42, "D", 12000, 5000_00, 0, 0, "approved", 5000_00},
		{"band D large request countered to limit", 42, "D", 12000, 40000_00, 0, 0, "counter", 12000_00},
		{"band E always declined", 70, "E", 100000, 40000_00, 0, 0, "declined", 0},
